...
/**
 * This class provides an empty implementation of {@link YLenguajeParserListener},
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
@SuppressWarnings("CheckReturnValue")
public class YLenguajeParserBaseListener implements YLenguajeParserListener {
	/**
	 * {@inheritDoc}
	 *
