// Generated from /home/juanpa/Documentos/Contacto-Extraterrstre-3d/Contacto-Extraterrstre-3d/src/main/java/antlr4/com/ZetarianoLexer.g4 by ANTLR 4.13.2
package antlr4.com;
...
public class ZetarianoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PUBLIC", "CLASS", "STRING", "INT", "BOOLEAN", "DOUBLE", "CHAR", "VOID", 
			"RETURN", "NEW", "IF", "ELSE", "TRUE", "FALSE", "SWITCH", "CASE", "DEFAULT", 
			"BREAK", "FOR", "CONTINUE", "WHILE", "DO", "PRINTLN", "PRINT", "READLN", 
			"NULL_VAL", "LPAREN", "RPAREN", "LLLAVE", "RLLAVE", "PUNTO_COMA", "COMA", 
			"INTERRG", "DOS_PUNTOS", "PUNTO", "LCORCH", "RCORCH", "IGUAL", "NO_IGUAL", 
			"MAYOR_IGUAL", "MENOR_IGUAL", "MAYOR", "MENOR", "AND", "OR", "NOT", "INCREMENTO", 
			"DECREMENTO", "SUMA_IGL", "RESTA_IGL", "MULT_IGL", "SUMA", "RESTA", "MULT", 
			"DIV", "MOD", "ASIGNACION", "ID", "INTEGER", "DOUBLES", "STRINGS", "CHARS", 
	...
	public ZetarianoLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "ZetarianoLexer.g4"; }
